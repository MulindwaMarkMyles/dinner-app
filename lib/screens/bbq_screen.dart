...
class BbqScreen extends StatefulWidget {
  ...
  const BbqScreen({super.key, required this.scannedUser});
...
class _BbqScreenState extends State<BbqScreen> {
  ...
  Future<void> _consumeBbq() async {
    ...
    try {
      final user = await _apiService.consumeBbq(
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildAllowanceItem('LUNCH', _user!.lunchesRemaining, Colors.orange),
              _buildAllowanceItem('DINNER', _user!.dinnersRemaining, Colors.green),
              _buildAllowanceItem('DRINKS', _user!.drinksRemaining, Colors.blue),
            ],
          ),
        ],
      ),
